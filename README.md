...
install  [go-dae](https://github.com/daefrom/go-dae).

Clone & compile:

    git clone https://github.com/daefrom/dae-pool.git
    cd dae-pool
    sudo chmod 755 -R *
    make
...
See example [nginx-default](https://github.com/daefrom/dae-pool/blob/master/misc/nginx-default.conf)
...
[DAEFROM](https://github.com/daefrom)
